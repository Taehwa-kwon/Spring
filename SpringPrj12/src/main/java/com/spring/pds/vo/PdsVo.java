...
public class PdsVo {
		...
		/* 파일이 여러개 일때 */
		private int filecount; //출력할 파일의 수
		...
		private int recordcount; //전체 자료수
		...
		public PdsVo(int idx, String menu_id, String title, String cont, String writer, String regdate, int readcount,
				...
				int nextnowpage, int recordcount, int totalpagecount, int pagestartnum, int pageendnum, int pagegroupnum,
		...
		public String toString() {
			return "PdsVo [idx=" + idx + ", menu_id=" + menu_id + ", title=" + title + ", cont=" + cont + ", writer="
					...
					+ fileext + ", sfilename=" + sfilename + ", filescount=" + filecount + ", nowpage=" + nowpage
					+ ", prevnowpage=" + prevnowpage + ", nextnowpage=" + nextnowpage + ", recordcount=" + recordcount
